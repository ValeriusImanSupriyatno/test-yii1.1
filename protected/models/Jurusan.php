...
class Jurusan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kode_jurusan, nama_jurusan', 'required'),
			array('kode_jurusan, nama_jurusan', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_jurusan, kode_jurusan, nama_jurusan', 'safe', 'on'=>'search'),
		);
	}
    ...
    {
        return CHtml::listData($this->findAll(array('order'=>'nama_jurusan')), 'id_jurusan', 'nama_jurusan');
    }
}
